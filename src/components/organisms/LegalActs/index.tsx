  ...
  return (
    <PaddingBox>
      <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="pt-br">
        <TripleDiv>
          ...
          <FormControl sx={{ width: "20%", marginRight: "5px" }}>
            ...
            >
              ...
              <MenuItem value="Lei Complementar">Lei Complementar</MenuItem>
              <MenuItem value="Lei Ordinaria">Lei Ordinaria</MenuItem>
        ...
        <TextField fullWidth sx={fieldProps} label="Veículo de publicação" />
        ...
        <TripleDiv>
          ...
          <FormControl sx={{ width: "20%", marginRight: "10px" }}>
            <InputLabel id="alteration-label">Tipo de alteração</InputLabel>
            <Select
