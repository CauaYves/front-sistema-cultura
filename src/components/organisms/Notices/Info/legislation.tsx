      ...
      <ol>
        <li>
          <Typography variant="body2">
            ...
            janeiro, o programa estadual de fomento e incentivo a cultura, e
            apresenta como anexo único as diretrizes e estratégias do plano
            estadual de cultura.
          </Typography>
        </li>
        <li>
          <Typography variant="body2">
            ...
            – Regulamenta o Capítulo I, do Título II, da Lei Estadual n.º 7.035,
            de 07 de julho de 2015, que institui o Sistema Estadual de Cultura
            do Estado do Rio de Janeiro, o Programa Estadual de Fomento e
            Incentivo à Cultura, e apresenta como anexo único as diretrizes e
            estratégias do Plano Estadual de Cultura, e dá outras providências.
          </Typography>
        </li>
        <li>
          <Typography variant="body2">
