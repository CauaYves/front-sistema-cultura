        ...
        <Box>
            <Paper sx={{ padding: '0px 20px 20px 0px' }}>
                <GridBox>
                    ...
                    <StyledTextField
                        required
                        label="Nome da proposta cultural"
                    />
                    <StyledTextField
                        required
                        label="Razão social do proponente"
                    />
                ...
                <Box>
                    ...
                    <Typography variant="subtitle2">
                        No presente termo, o PROPONENTE declara que assume o
                        compromisso de estar adimplente junto aos órgãos e
