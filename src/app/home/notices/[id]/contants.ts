const subscriptionInformation = [
    ...
    {
        title: 'Documentação do Proponente Pessoa Jurídica',
        description: `Cópia do Contrato Social ou Estatuto Social com última alteração/última ata;
    ...
    },
    {
        ...
        description: `Documentos que comprovem a anuência de artistas envolvidos no projeto;
