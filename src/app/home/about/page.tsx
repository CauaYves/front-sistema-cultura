        ...
        >
            ...
            >
                ...
                <Typography variant="body1" component="p">
                    ...
                    Culturalize respeitar a sua privacidade em relação a
                    qualquer informação sua que possamos coletar no site{' '}
                    <Link
                        href="https://front-sistema-cultura.vercel.app/"
                        target="_blank"
                    >
                        Culturalize
                    </Link>
                ...
                <Typography variant="body1" component="p">
                    ...
                    como será usado. Os dados sensíveis do formulário de
                    Identificação de Agente Cultural não são compartilhados, os
                    dados não-sensíveis como nome, profissão, área de atuação,
                    entre outros... são usados para melhoria do processo de
                    credenciamento.
                </Typography>
                <br />
                <Typography variant="body1" component="p">
                ...
                <Typography>
                    Esta política é efetiva a partir de 28 de Março 2024.
                </Typography>
                <br />
                <br />
                <h2>
                ...
                <p>
                    <span>
                        Ao acessar ao site{' '}
                        <a href="https://front-sistema-cultura.vercel.app/">
                            Culturalize
                        </a>
                ...
                <p>
                    <span>
                        ...
                        Culturalize , apenas para visualização transitória
                ...
                <ol>
                    ...
                    <li>
                        <span>
                            ...
                            qualquer software contido no site Culturalize;&nbsp;
                        </span>
                    </li>
                    <li>
                        <span>
                ...
                <p>
                    <span>
                        ...
                        por Culturalize a qualquer momento. Ao encerrar a
                ...
                <ol>
                    <li>
                        <span>
                            Os materiais no site da Culturalize são fornecidos
                            {"'como estão'"}. Culturalize não oferece garantias,
                            expressas ou implícitas, e, por este meio, isenta e
                            nega todas as outras garantias, incluindo, sem
                            limitação, garantias implícitas ou condições de
                            comercialização, adequação a um fim específico ou
                            não violação de propriedade intelectual ou outra
                            violação de direitos.
                        </span>
                    </li>
                    <li>
                        <span>
                            Além disso, o Culturalize não garante ou faz
                ...
                <p>
                    <span>
                        Em nenhum caso o Culturalize ou seus fornecedores serão
                        ...
                        incapacidade de usar os materiais em Culturalize, mesmo
                        que Culturalize ou um representante autorizado da
                        Culturalize tenha sido notificado oralmente ou por
                        ...
                        conseqüentes ou incidentais, essas limitações podem não
                        se aplicar a você.
                    </span>
                </p>
                <h2>
                ...
                <p>
                    <span>
                        Os materiais exibidos no site da Culturalize podem
                        incluir erros técnicos, tipográficos ou fotográficos.
                        Culturalize não garante que qualquer material em seu
                        site seja preciso, completo ou atual. Culturalize pode
                        fazer alterações nos materiais contidos em seu site a
                        qualquer momento, sem aviso prévio. No entanto,
                        Culturalize não se compromete a atualizar os materiais.
                    </span>
                </p>
                <h2>
                    <span>6. Links</span>
                ...
                <p>
                    <span>
                        O Culturalize não analisou todos os sites vinculados ao
                        seu site e não é responsável pelo conteúdo de nenhum
                        site vinculado. A inclusão de qualquer link não implica
                        endosso por Culturalize do site. O uso de qualquer site
                ...
                <p>
                    <span>
                        O Culturalize pode revisar estes termos de serviço do
                ...
                <p>
                    <span>
                        ...
                        acordo com as leis do Culturalize e você se submete
