    ...
    >
      ...
      >
        ...
        <Typography variant="body1" component="p">
          A sua privacidade é importante para nós. É política do Culturalize
        ...
        <Typography variant="body1" component="p">
          ...
          que estamos coletando e como será usado. Os dados sensíveis do
          formulário de Identificação de Agente Cultural não são compartilhados,
          os dados não-sensíveis como nome, profissão, área de atuação, entre
          outros... são usados para melhoria do processo de credenciamento.
        </Typography>
        <br />
        <Typography variant="body1" component="p">
        ...
        <ul>
          ...
          <li>
            ...
            (softwares) do Culturalize, de seus fornecedores ou terceiros, para
        ...
        <p>
          <span>
            Ao acessar ao site{" "}
            <a href="https://front-sistema-cultura.vercel.app/">Culturalize</a>,
        ...
        <p>
          <span>
            ...
            materiais (informações ou software) no site Culturalize , apenas
        ...
        <ol>
          ...
          <li>
            <span>
              ...
              software contido no site Culturalize;&nbsp;
            </span>
          </li>
          <li>
            <span>
        ...
        <p>
          <span>
            ...
            dessas restrições e poderá ser rescindida por Culturalize a qualquer
        ...
        <ol>
          <li>
            <span>
              ...
              {"'como estão'"}. Culturalize não oferece garantias, expressas ou
          ...
          <li>
            <span>
              Além disso, o Culturalize não garante ou faz qualquer
        ...
        <p>
          <span>
            Em nenhum caso o Culturalize ou seus fornecedores serão responsáveis
            ...
            uso ou da incapacidade de usar os materiais em Culturalize, mesmo
            que Culturalize ou um representante autorizado da Culturalize tenha
        ...
        <p>
          <span>
            Os materiais exibidos no site da Culturalize podem incluir erros
            técnicos, tipográficos ou fotográficos. Culturalize não garante que
            qualquer material em seu site seja preciso, completo ou atual.
            Culturalize pode fazer alterações nos materiais contidos em seu site
            a qualquer momento, sem aviso prévio. No entanto, Culturalize não se
        ...
        <p>
          <span>
            O Culturalize não analisou todos os sites vinculados ao seu site e
            não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
            de qualquer link não implica endosso por Culturalize do site. O uso
        ...
        <p>
          <span>
            O Culturalize pode revisar estes termos de serviço do site a
        ...
        <p>
          <span>
            ...
            as leis do Culturalize e você se submete irrevogavelmente à
